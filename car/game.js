...
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        // method to add the car, methods represent x and y position
        this.addCar(250, 300);
    ...
    generateTerrain(graphics, mountainStart){
        ...
        graphics.lineStyle(16, 0xBEBEBE);
        graphics.beginPath();
        simpleSlope.forEach(function(point){
            graphics.lineTo(point.x, point.y);
        })
    ...
    addCar(posX, posY){
        ...
        // this is how we create the compund object
